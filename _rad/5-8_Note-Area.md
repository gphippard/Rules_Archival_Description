---
layout: single
title: "5.8 CARTOGRAPHIC MATERIALS, NOTE AREA"
permalink: /5-8/
toc: true
...
>
> Scale .1 square inches = 300,000 people
...
1. by recording the largest scale of the maps(s), chart(s) or image(s) for which the data are valid or
2. by recording the code representing the accuracy class of the item from a table of standard accuracy measures.
...
> In German
>
> Legend and notes in English and French
> (*Title, publisher, etc., in English*)
>
...
[^37]: Guidance for recording signatures and foliation for early printed atlases is provided in CM, 7B10b.

[^38]: Further guidance for early cartographic material is provided at CM, 7B20b-c.

[^39]: Further guidance is provided in CM, 11.
