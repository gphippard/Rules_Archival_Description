---
layout: single
title: "RAD2 Backgrounder: 2.0 Summary of Changes"
permalink: /rad2-backgrounder-changes/
toc: true
...
RAD2 asserts that the use of _International Standard Bibliographic Description_ punctuation is optional, and that it is up to the repository how descriptions are presented to the end-user. For optional use, a list of prescribed punctuation is included as an appendix.
